...
export default function PropertiesList() {
  ...
  useEffect(() => {
    ...
    async function loadStats() {
      if (!token) return;
      try {
        const { data } = await axios.get(`${apiBase}/api/properties/broker/stats`, { headers });
  ...
  const renderCell = (key, p, helpers) => {
    ...
    switch (key) {
      ...
      case 'actions':
        return (
          <div className="brokerproperties-actions-col">
            <button
              className="brokerproperties-link"
              onClick={() => openView(p)}
              title="View"
              aria-label="View"
            >
  ...
  return (
    <div className="brokerproperties-root">
      <div className="brokerproperties-head">
        <div>
          <h1 className="brokerproperties-title">My Properties</h1>
          <div className="brokerproperties-sub">Manage and view all your property listings</div>
        </div>
        <div className="brokerproperties-actions">
          <div className="brokerproperties-tableactions">
            ...
            <button
              type="button"
              ref={columnButtonRef}
              className="brokerproperties-columns-btn"
            ...
            {columnMenuOpen && (
              <div className="brokerproperties-colmenu" ref={columnMenuRef} role="menu">
                <div className="brokerproperties-colmenu-head">Show columns</div>
                {COLUMN_OPTIONS.map((col) => (
                  <label key={col.id} className="brokerproperties-colmenu-item">
                    <input
                      type="checkbox"
      ...
      {/* Stats Cards */}
      <div className="brokerproperties-stats">
        <div className="brokerproperties-stat-card">
          <div className="brokerproperties-stat-content">
            <div className="brokerproperties-stat-title">Total Properties</div>
            <div className="brokerproperties-stat-value">{stats.totalProperties}</div>
            <div className="brokerproperties-stat-subtitle">+{stats.newThisWeek} new this week</div>
          </div>
          <div className="brokerproperties-stat-icon" style={{ background: '#fef3c7', color: '#f59e0b' }}>
        ...
        <div className="brokerproperties-stat-card">
          <div className="brokerproperties-stat-content">
            <div className="brokerproperties-stat-title">High Demand property</div>
            <div className="brokerproperties-stat-value">{stats.highDemandProperties}</div>
            <div className="brokerproperties-stat-subtitle">Most viewed within 24 hours</div>
          </div>
          <div className="brokerproperties-stat-icon" style={{ background: '#d1fae5', color: '#10b981' }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="brokerproperties-stat-card">
          <div className="brokerproperties-stat-content">
            <div className="brokerproperties-stat-title">Published</div>
            <div className="brokerproperties-stat-value">{stats.publishedProperties}</div>
            <div className="brokerproperties-stat-subtitle">All active and published properties</div>
          </div>
          <div className="brokerproperties-stat-icon" style={{ background: '#dbeafe', color: '#3b82f6' }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
        ...
        <div className="brokerproperties-stat-card">
          <div className="brokerproperties-stat-content">
            <div className="brokerproperties-stat-title">Active Leads</div>
            <div className="brokerproperties-stat-value">{stats.activeLeads}</div>
            <div className="brokerproperties-stat-subtitle">Leads from last 24 hours</div>
          </div>
          <div className="brokerproperties-stat-icon" style={{ background: '#e9d5ff', color: '#8b5cf6' }}>
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="brokerproperties-toolbar">
        <div className="brokerproperties-search">
        ...
        <select className="brokerproperties-select" value={typeFilter} onChange={(e) => setTypeFilter(e.target.value)}>
          <option>All Types</option>
          {[...new Set(items.map(x => x.type))].filter(Boolean).map(t => (<option key={t}>{t}</option>))}
        </select>
        <select className="brokerproperties-select" value={'Published'} readOnly>
          <option>Published</option>
        </select>
      </div>

      <div className="brokerproperties-card">
        <div className="brokerproperties-tablewrap">
          <table className="brokerproperties-table" role="table">
            <thead>
              <tr>
                ...
                {visibleColumns.map((col) => {
                  ...
                  return (
                    <th key={col.id} scope="col" className={`col-${col.id}`}>
                      <div className="brokerproperties-th-filter">
                        <span>{col.label}</span>
                        {hasFilter && (
                          <div className="brokerproperties-th-filter-btn-wrap">
                            <button
                              type="button"
                              data-filter-col={col.id}
                              className={`brokerproperties-th-filter-btn ${currentFilter ? 'active' : ''}`}
                            ...
                            {isMenuOpen && (
                              <div
                                className="brokerproperties-filter-menu"
                                ref={(el) => { if (el) filterMenuRefs.current[col.id] = el; }}
                              >
                                <div className="brokerproperties-filter-menu-item">
                                  <button
                                    type="button"
                                ...
                                {filterValuesForCol.map((val) => (
                                  <div key={val} className="brokerproperties-filter-menu-item">
                                    <button
                                      type="button"
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={visibleColumns.length + 1} className="brokerproperties-table-empty">Loading properties…</td>
                </tr>
              ) : error ? (
                <tr>
                  <td colSpan={visibleColumns.length + 1} className="brokerproperties-error">{error}</td>
                </tr>
              ) : filtered.length === 0 ? (
                <tr>
                  <td colSpan={visibleColumns.length + 1} className="brokerproperties-table-empty">No properties found</td>
                </tr>
              ) : (
        ...
        {hasMore && (
          <div style={{ textAlign: 'center', padding: '20px' }}>
            <button
              ...
              className="brokerproperties-btn brokerproperties-btn-primary"
      ...
      {selected && (
        <div className="brokerproperties-modal-overlay" onClick={() => setSelected(null)}>
          <div className="brokerproperties-modal" onClick={(e) => e.stopPropagation()}>
            <div className="brokerproperties-view-head">
              <div>
                <h3 className="brokerproperties-view-title">Property Details</h3>
                <div className="brokerproperties-view-sub">Review property information</div>
              </div>
              <button className="brokerproperties-iconbtn" onClick={() => setSelected(null)} aria-label="Close">×</button>
            </div>
            {selected.loading && <div className="brokerproperties-loading">Loading...</div>}
            {!selected.loading && selected.details && (() => {
              ...
              return (
              <div className="brokerproperties-detail">
                <div className="brokerproperties-detail-left">
                  <div className="brokerproperties-carousel">
                    <button className="brokerproperties-nav brokerproperties-prev" onClick={() => go(-1)} aria-label="Previous">‹</button>
                    <img className="brokerproperties-detail-img" src={currentUrl} alt="" />
                    <button className="brokerproperties-nav brokerproperties-next" onClick={() => go(1)} aria-label="Next">›</button>
                  </div>
                  {urls.length > 1 && (
                    <div className="brokerproperties-thumbs">
                      {urls.map((u, idx) => (
                        <img key={idx} src={u} className={`brokerproperties-thumb ${idx === slideIdx ? 'active' : ''}`} onClick={() => setSlideIdx(idx)} alt="" />
                      ))}
                </div>
                  )}
                  ...
                  {(() => {
                    ...
                    return (
                      <div className="brokerproperties-miniinputs">
                        <div className="brokerproperties-field">
                          <label className="brokerproperties-label">Built-up Area</label>
                          <input disabled value={built} />
                        </div>
                        <div className="brokerproperties-field">
                          <label className="brokerproperties-label">Carpet Area</label>
                          <input disabled value={carpet} />
                        </div>
                        <div className="brokerproperties-field">
                          <label className="brokerproperties-label">Super Area</label>
                ...
                <div className="brokerproperties-detail-right">
                  <div className="brokerproperties-summary">
                    <h2 className="brokerproperties-detail-title">{selected.details.title || selected.title}</h2>
                    <div className="brokerproperties-detail-price">₹{selected.details?.features?.expected_price || selected.price || selected.expected_price || '-'}</div>
                    <dl className="brokerproperties-meta">
                      <div>
                        <dt>Type</dt>
                  ...
                  <div className="brokerproperties-detail-desc">
                    <div className="brokerproperties-view-label">Description</div>
                  ...
                  {(() => {
                    ...
                    return (
                      <>
                        <div className="brokerproperties-formgrid">
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Property For</label><input disabled value={pretty(selected.details.property_for || selected.propertyFor || 'sell')} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Building Type</label><input disabled value={pretty(selected.details.building_type || selected.buildingType)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Sale Type</label><input disabled value={pretty(f.sale_type)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Availability</label><input disabled value={pretty(f.availability)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Approving Authority</label><input disabled value={pretty(f.approving_authority)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Ownership</label><input disabled value={pretty(f.ownership)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">RERA Status</label><input disabled value={pretty(f.rera_status)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">RERA Number</label><input disabled value={pretty(f.rera_number)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">No. of Floors</label><input disabled value={pretty(f.no_of_floors)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Property on Floor</label><input disabled value={pretty(f.property_on_floor)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Furnishing</label><input disabled value={pretty(f.furnishing_status)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Facing</label><input disabled value={pretty(f.facing)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Flooring</label><input disabled value={pretty(f.flooring_type)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Age of Property</label><input disabled value={pretty(f.age_years)} /></div>

                          <div className="brokerproperties-field"><label className="brokerproperties-label">Built-up Area</label><input disabled value={areaWithUnit(f.built_up_area, f.area_unit)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Carpet Area</label><input disabled value={areaWithUnit(f.carpet_area, f.carpet_area_unit)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Super Area</label><input disabled value={areaWithUnit(f.super_area, f.super_area_unit)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Booking Amount</label><input disabled value={pretty(f.booking_amount)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Maintenance</label><input disabled value={pretty(f.maintenance_charges)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Possession By</label><input disabled value={pretty(f.possession_by)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Bedrooms</label><input disabled value={pretty(f.num_bedrooms)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Bathrooms</label><input disabled value={pretty(f.num_bathrooms)} /></div>
                          <div className="brokerproperties-field"><label className="brokerproperties-label">Balconies</label><input disabled value={pretty(f.num_balconies)} /></div>
                        </div>

                        {rooms.length > 0 && (
                          <div className="brokerproperties-section">
                            <div className="brokerproperties-view-label">Additional Rooms</div>
                            <div className="brokerproperties-chips">
                              {rooms.map((r, i) => (<span key={i} className="brokerproperties-chip">{String(r)}</span>))}
                            </div>
                          </div>
                        )}
                        ...
                        {amenities.length > 0 && (
                          <div className="brokerproperties-section">
                            <div className="brokerproperties-view-label">Amenities</div>
                            <div className="brokerproperties-chips">
                              {amenities.map((a, i) => (<span key={i} className="brokerproperties-chip">{String(a)}</span>))}
                            </div>
                          </div>
                        )}
                        ...
                        {highlights.length > 0 && (
                          <div className="brokerproperties-section">
                            <div className="brokerproperties-view-label">Highlights</div>
                            <div className="brokerproperties-chips">
                              {highlights.map((h, i) => (<span key={i} className="brokerproperties-chip">{String(h)}</span>))}
                            </div>
                          </div>
                        )}
                        ...
                        {nearby.length > 0 && (
                          <div className="brokerproperties-section">
                            <div className="brokerproperties-view-label">Nearby Landmarks</div>
                            <div className="brokerproperties-chips">
                              {nearby.map((n, i) => (<span key={i} className="brokerproperties-chip">{String(n)}</span>))}
                            </div>
                          </div>
                        )}
                      </>
