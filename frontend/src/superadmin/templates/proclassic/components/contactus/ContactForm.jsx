...
// Shared form component (used by both Home and Contact page)
export function ContactForm({ site: siteProp, showTitle = true, compact = false }) {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!tenantDb) {
      ...
      console.error('ContactForm - tenantDb is missing. Cannot submit lead without tenant database.');
      return;
    }
  ...
  return (
    <section className={compact ? "pc-contact__form pc-contact__form--compact" : "pc-contact__form"}>
      {showTitle && <h3 className="pc-contact__heading">Send us a Message</h3>}
