...
function getTenantFromRequest(req) {
  // Prefer tenant_db from authenticated company token; fallback to header for public signup
...
// List all tenant users for the authenticated company's tenant
...
// Update a tenant user's profile (by company within same tenant)
